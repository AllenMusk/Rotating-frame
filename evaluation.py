...
if __name__ == '__main__':
    ...
    #
    evaluation(
        detoutput='/media/huang2/Samsung_T5/YOLOV5_DOTA/YOLOv5_DOTA_OBB-master/DOTA_demo_view/detection',
        imageset=r'/media/huang2/Samsung_T5/YOLOV5_DOTA/YOLOv5_DOTA_OBB-master/DOTA_demo_view/row_images',
        annopath=r'/media/huang2/Samsung_T5/YOLOV5_DOTA/YOLOv5_DOTA_OBB-master/DOTA_demo_view/row_DOTA_labels/{:s}.txt',
        classnames=classnames_inVal
    )

    draw_DOTA_image(imgsrcpath=r'/media/huang2/Samsung_T5/YOLOV5_DOTA/YOLOv5_DOTA_OBB-master/DOTA_demo_view/row_images',
                    imglabelspath=r'/media/huang2/Samsung_T5/YOLOV5_DOTA/YOLOv5_DOTA_OBB-master/DOTA_demo_view/detection/result_txt/result_merged',
                    dstpath=r'/media/huang2/Samsung_T5/YOLOV5_DOTA/YOLOv5_DOTA_OBB-master/DOTA_demo_view/detection/merged_drawed',
